...
local function set_highlights()
	local utilities = require("geza.utilities")
	local palette = require("geza.palette")
	...
	local function make_border(fg)
		...
		return {
			fg = fg,
			bg = (config.options.extend_background_behind_borders and not styles.transparency) and palette.base -- palette.surface
				or "NONE",
		}
	end
	...
	local legacy_highlights = {
		...
		["@number"] = { link = "Number" },
		["@parameter"] = { fg = palette.leaf, italic = styles.italic },
	...
	local default_highlights = {
		...
		djangoArgument = { fg = palette.gold, italic = styles.italic },
		djangoVarBlock = { fg = palette.rose, italic = styles.italic },
		djangoTagBlock = { fg = palette.rose, italic = styles.italic },
		-- EndOfBuffer = {},
		...
		Keyword = { fg = palette.pine, bold = styles.bold },
		...
		-- LspReferenceRead = { bg = palette.highlight_med, underline = true },
		...
		Type = { fg = palette.foam, bold = styles.bold },
		TypeDef = { link = "Type" },
		...
		htmlArg = { fg = palette.leaf, italic = styles.italic },
		...
		htmlTag = { fg = palette.leaf, italic = styles.italic },
		...
		["@keyword.import"] = { fg = palette.pine, bold = styles.bold },
		["@keyword.storage"] = { fg = palette.foam },
		["@keyword.repeat"] = { fg = palette.pine, bold = styles.bold },
		...
		["@tag"] = { link = "Tag" },
		["@tag.attribute"] = { fg = palette.iris, italic = styles.italic },
		...
		RenderMarkdownCodeInline = { fg = palette.gold, bg = palette.overlay },
		...
		BlinkCmpLabelDescription = { fg = palette.muted },
		-- BlinkCmpMenu = { fg = palette.subtle, bg = palette.base },
		BlinkCmpMenu = { fg = palette.highlight_med, bg = palette.base },
	...
	local transparency_highlights = {
		...
		RenderMarkdownCode = { bg = palette.overlay, blend = 20 },
	}
	...
	if config.options.enable.terminal then
		...
		augroup geza
			...
			autocmd ColorSchemePre * autocmd! geza
		augroup END
		]])
	end
end
